...
@section('main-container')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="class-details-text">
                        <div class="cd-pic">
                            <img src="{{ url('frontend/img/classes/class-detailsl.jpg') }}" alt="class-details">
                        </div>
                        <div class="cd-text">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cd-trainer-pic">
                                        <img src="{{ url('frontend/img/classes/trainer-profile.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    <section class="class-timetable-section class-details-timetable spad pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
